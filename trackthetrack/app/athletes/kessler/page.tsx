...
const KesslerPage: React.FC = () => {
  const urls = youtube['Hobbs Kessler'];
...
return (
  <div className="min-h-screen bg-gray-100 p-6">
    ...
    <button
      ...
      {youtube['Hobbs Kessler'].slice(currentIndex, currentIndex + 3).map((url, index) => (
