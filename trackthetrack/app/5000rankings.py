...
def top20_scrape():
    html= requests.get('https://worldathletics.org/records/toplists/middlelong/5000-metres/all/men/senior/2024?regionType=world&page=1&bestResultsOnly=true&maxResultsByCountry=all&eventId=10229609&ageCategory=senior')
...
top20_df.to_json('5000m.json', orient='records')