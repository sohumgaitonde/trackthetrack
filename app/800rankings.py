...
def get_names(soup): #Gets all the top 800 names
...
def top20_scrape():
    html= requests.get('https://worldathletics.org/records/toplists/middlelong/800-metres/all/men/senior/2024?regionType=world&timing=electronic&page=1&bestResultsOnly=true&maxResultsByCountry=all&eventId=10229501&ageCategory=senior')
...
top20_df.to_json('800m.json', orient='records')